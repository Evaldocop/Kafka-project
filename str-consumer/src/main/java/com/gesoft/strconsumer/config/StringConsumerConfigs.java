package com.gesoft.strconsumer.config;
...
@Configuration
public class StringConsumerConfigs {
	...
	public ConsumerFactory<String, String> consumerFactory() {
		...
		configs.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, proprerties.getBootstrapServers());
	...
	private RecordInterceptor<String, String> validMessage() {
		...
		return record->{
			...
			if(record.value().contains("Teste")) {
				log.info("Possue a palavra Teste");
				return record;
			}
			return record;
